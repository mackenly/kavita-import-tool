...
3. The code might not be signed for your operating system. So you may need to allow the program to run in your security settings. I hope to fix this evenutaly, but the costs are prohibitive at the moment ([Interested in sponsoring this?](https://github.com/sponsors/mackenly)).
